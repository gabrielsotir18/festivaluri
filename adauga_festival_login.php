...
<body>
	 ...
	 <form action="db_addFestivals.php">
  <label for="fname">Introduceti numele festivalului:</label><br>
  <input type="text" name="newFestivalName"><br>
  <label for="fname">Introduceti site-ul festivalului:</label><br>
  <input type="text" name="newFestivalSite"><br>
  <label for="fname">Introduceti numar de contact:</label><br>
  <input type="text" name="newFestivalContact"><br>
  <label for="fname">Introduceti sponsorul festivalului:</label><br>
  <input type="text" name="newFestivalSponsor"><br>
