...
$newTrupaName = $_GET["newTrupaName"];
$newTrupaGen = $_GET["newTrupaGen"];
$newTrupaContact = $_GET["newTrupaContact"];
$newTrupaNumarMembrii = $_GET["newTrupaNumarMembrii"];
$newTrupaSolist = $_GET["newTrupaSolist"];


//Cautare dupa numele festivalelor:
echo "<h2>Ai adaugat trupa " . $newTrupaName .". </h2>";
$sql = "INSERT INTO tblTrupe (numeTrupa, contactTrupa, genTrupa, numarMembrii, solistPrincipal) 
			VALUES ('" . $newTrupaName . "', '" .$newTrupaContact ."', '" . $newTrupaGen . "', ". $newTrupaNumarMembrii .", '". $newTrupaSolist ."')";
