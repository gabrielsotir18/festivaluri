...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    ...
    <a href="Program.php" class="w3-bar-item w3-button w3-theme-l1">Program</a>
...
<div class="w3-main" style="margin-left:100px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Program</h1>
      <p><?php
			include "db_show_programTrupe.php";
		  ?></p>
    </div>
    <div class="w3-third w3-container">
      <p class="w3-border w3-padding-large w3-padding-32 w3-center"><img src = "img/tiesto.jpg" width="500px"></p>
      <p class="w3-border w3-padding-large w3-padding-64 w3-center"><img src = "img/ImaginDragons.jpg" width="500px"></p>
    </div>
  </div>
