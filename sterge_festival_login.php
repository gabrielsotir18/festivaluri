...
<body>
	 ...
	 <form action="db_deleteFestivals.php">
  <label for="fname">Introduceti numele festivalului pe care doriti sa il stergeti:</label><br>
  <input type="text" name="deletedFestivalName"><br>
