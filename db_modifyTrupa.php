...
$selectedTrupaName = $_POST["selectedTrupaName"];
//echo $selectedTrupaName;
$choice = $_POST['choice'];
//echo $choice;
...
echo "<h2> Trupei " . $selectedTrupaName ." i-a fost modificata valoarea de pe coloana ". $choice ." in ". $newValue .". </h2>";
$sql = "UPDATE tblTrupe SET ". $choice ." = '" . $newValue . "' WHERE numeTrupa = '" . $selectedTrupaName . "'";
