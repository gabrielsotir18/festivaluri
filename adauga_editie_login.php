...
<body>
     <h1>Hello, <?php echo $_SESSION['name']; ?></h1>
			...
			<form action = "db_addEditie.php">
			<label for="fname">Selectati festivalul dorit:</label>
			 <?php

			include "db_connect.php"; 
			

				$result = $mysqli->query("select * from tblFestivaluri");
				...
				echo "</html>";
			?> <br>
			<label for="fname">introduceti data editiei festivalului(YYYY-MM-DD):</label><br>
			<input type="date" name="newDataEditie"><br>
			<label for="fname">Introduceti locatia editiei festivalului:</label><br>
			<input type="text" name="newLocatieEditie"><br>
