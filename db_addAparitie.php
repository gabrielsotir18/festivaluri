...
$idEditie = $_GET["id1"];
$idTrupa = $_GET["id2"];
$newOraAparitie = $_GET["newOraAparitie"];
$newDurataAparitie = $_GET["newDurataAparitie"];


//Cautare dupa numele festivalelor:
echo "<h2>Aparitia a fost adaugata. </h2>";
$sql = "INSERT INTO tblAparitii (editie, trupa, oraAparitie, durataAparitie) 
			VALUES ('" . $idEditie . "', '" .$idTrupa ."', '" . $newOraAparitie . "',". $newDurataAparitie .")";
