...
$newFestivalName = $_GET["newFestivalName"];
$newFestivalSite = $_GET["newFestivalSite"];
$newFestivalContact = $_GET["newFestivalContact"];
$newFestivalSponsor = $_GET["newFestivalSponsor"];


//Cautare dupa numele festivalelor:
echo "<h2>Ai adaugat festivalul " . $newFestivalName .". </h2>";
$sql = "INSERT INTO tblFestivaluri (numeFestival, siteFestival, contactFestival, sponsorFestival) 
			VALUES ('" . $newFestivalName . "', '" .$newFestivalSite ."', '" . $newFestivalContact . "', '". $newFestivalSponsor ."')";
