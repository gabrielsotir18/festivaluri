...
$deletedFestivalName = $_GET["deletedFestivalName"];



//Cautare dupa numele festivalelor:
echo "<h2> Festivalul " . $deletedFestivalName ." a fost sters. </h2>";
$sql = "DELETE FROM tblFestivaluri WHERE numeFestival = '" . $deletedFestivalName . "'";
