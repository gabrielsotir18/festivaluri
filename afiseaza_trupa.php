...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo " Trupa: " . $row["numeTrupa"]. 
		" - Gen muzical: " .  $row["genTrupa"] . " - Numar de contact: " . $row["contactTrupa"]." - Solist principal: ". $row["solistPrincipal"] ." - Numarul de membrii: ". $row["numarMembrii"] ."<br>";
  }
} else {
	echo "0 results";
}
