...
$selectedFestivalName = $_POST["selectedFestivalName"];
//echo $selectedFestivalName;
$choice = $_POST['choice'];
//echo $choice;
...
echo "<h2> Festivalului " . $selectedFestivalName ." i-a fost modificata valoarea de pe coloana ". $choice ." in ". $newValue .". </h2>";
$sql = "UPDATE tblFestivaluri SET ". $choice ." = '" . $newValue . "' WHERE numeFestival = '" . $selectedFestivalName . "'";
