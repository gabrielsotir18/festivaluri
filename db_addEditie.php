...
$idFestival = $_GET["id"];
//$festivalName = $_GET["numeFestival"];
$newDataEditie = $_GET["newDataEditie"];
$newLocatieEditie = $_GET["newLocatieEditie"];


//Cautare dupa numele festivalelor:
echo "<h2>Editia festivalului a fost adaugata. </h2>";
$sql = "INSERT INTO tblEditiiFestivaluri (festival, dataEditie, locatieEditie) 
			VALUES ('" . $idFestival . "', '" .$newDataEditie ."', '" . $newLocatieEditie . "')";
