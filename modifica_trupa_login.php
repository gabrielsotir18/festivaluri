...
<body>
	 ...
	 <form action="db_modifyTrupa.php"  method = "post">
	  <label for="fname">Introduceti numele festivalului pe care doriti sa il modificati:</label><br>
	  <input type="text" name="selectedTrupaName"><br>
	  <label for="fname">Introduceti ce doriti sa modificati</label><br>
	  <select id="selectype" name="choice">
		<option value="numeTrupa">Numele trupei</option>
		<option value="genTrupa">Genul muzical al trupei</option>
		<option value="numarMembrii" type="number">Numarul de membrii</option>
		<option value="contactTrupa">Numarul de contact</option>
		<option value="solistPrincipal">Solistul principal</option>
	  </select>
